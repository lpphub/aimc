      ...
      <button
        ...
        className={cn(
          ...
          filterTagCount > 0
            ...
            : 'bg-surface-container-high border-border/30 text-muted-foreground hover:text-primary hover:border-primary/30'
        )}
      >
  ...
  return (
    <div className='flex h-[calc(100vh-400px)] items-center justify-center'>
      <button
        ...
        className='flex flex-col items-center justify-center gap-4 p-12 bg-card/30 border-dashed border-2 border-border/30 hover:border-primary/50 hover:bg-primary/5 transition-all rounded-2xl group'
      >
